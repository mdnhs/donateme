...
class AdduserController extends Controller
{
    ...
    protected function adduserdata(Request $request)
    {
	   ...
	   $imgtype = $settings[0]->image_type;
		...
		DB::insert('insert into users (name,post_slug,email,password,phone,photo,admin,gender) values (?, ?,?, ?,?,?,?, ?)', [$name,$this->clean($name),$email,$password,$phone,$namef,$admin,$gender]);
