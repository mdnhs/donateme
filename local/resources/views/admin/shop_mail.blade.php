...
<body>
	...
	font-weight: normal;line-height: 1.4em;color: #444;margin-top: 10px; padding:10px;">
			...
			<p> City - <?php echo $shop_city;?></p> 	
			<p> Pin Code - <?php echo $shop_pin_code;?></p> 	
			<p> Country - <?php echo $shop_country;?></p> 	
			<p> State - <?php echo $shop_state;?></p> 	
			<p> Shop Phone No - <?php echo $shop_phone_no;?></p> 	
			<p> Description - <?php echo $shop_desc;?></p> 	
